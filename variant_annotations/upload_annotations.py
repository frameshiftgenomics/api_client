...
def main():
  ...
  grch37_annotations_project_id = api_mosaic.get_config('Project ids', 'annotations_grch37')
  grch38_annotations_project_id = api_mosaic.get_config('Project ids', 'annotations_grch38')
