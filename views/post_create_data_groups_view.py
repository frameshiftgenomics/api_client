...
def main():
  ...
  # POST the new view
  try:
    project.post_create_view(args.view_type, args.name, description = description, data_group_attribute_id = args.data_group_id, selected_attribute_ids = attribute_ids)
  except Exception as e:
