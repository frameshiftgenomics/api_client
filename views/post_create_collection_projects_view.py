...
def main():
  ...
  # POST the new view
  try:
    project.post_create_collection_projects_view(args.name, description = description, icon = icon, selected_attribute_ids = attribute_ids)
  except Exception as e:
...
def parse_command_line():
  ...
  # Optional arguments
  optional_arguments.add_argument('--attribute_filters', '-af', required = False, metavar = 'string', help = 'Attribute filters. See the API documentation for details')
