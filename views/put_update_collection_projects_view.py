...
def main():
  ...
  # Update the view
  try:
    project.put_update_collection_projects_view(args.name, description = description, icon = icon, selected_attribute_ids = attribute_ids, attribute_filters = attribute_filters, pagination = pagination)
  except Exception as e:
...
def parse_command_line():
  ...
  # Required arguments
  required_arguments.add_argument('--view_id', '-v', required = True, metavar = 'integer', help = 'The id of the view to update')
