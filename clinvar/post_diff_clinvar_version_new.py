...
def main():
  ...
  api_mosaic.post_diff_clinvar_version_new(annotation_version_id_a, annotation_version_id_b, project_ids = project_ids, annotation_filters = annotation_filters, generate_tasks = generate_tasks, emails = emails)
